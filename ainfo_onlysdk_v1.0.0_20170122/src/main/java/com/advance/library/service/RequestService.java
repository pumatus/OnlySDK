...
public class RequestService extends Service {
  ...
  public void onCreate() {
    ...
    // 也就是发送了action 为"pendingIntentOne"的intent
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    alarmManagerOne
        .setRepeating(AlarmManager.RTC_WAKEUP, triggerAtMillis(11, 22), (24 * 60 * 60 * 1000),
            pendingIntentOne);
    alarmManagerTwo
        .setRepeating(AlarmManager.RTC_WAKEUP, triggerAtMillis(11, 30), (24 * 60 * 60 * 1000),
            pendingIntentTwo);
